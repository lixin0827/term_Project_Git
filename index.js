...
// 推广商品切换
$('.promotion .top-stat ul li').mouseenter(function(){
    $(this).addClass('active').siblings().removeClass('active')
/*内容切换*/
var index = $(this).index(); //0=>left:0*1170
//左右移动
$('.promotion .title-bottom .inner-box').animate({
    'left': -index * 1170
});
});
/*返回顶部*/
...
window.addEventListener('scroll', function(){
    ...
    if(t>0){
       $('.search-input').addClass('boxs-active')
   }else{
       $('.search-input').removeClass('boxs-active')
   }
})